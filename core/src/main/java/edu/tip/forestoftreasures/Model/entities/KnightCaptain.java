...
/**
 * A KnightCaptain enemy encountered during battle sequences.
 * A more powerful version of the Knight with increased HP and strength.
 */
public class KnightCaptain extends Entity {
  private final Texture texture;
  private final Sound attackSound;

  public KnightCaptain(float initiative, Texture texture, Sound attackSound) {
    super(70f, 20f, initiative);
